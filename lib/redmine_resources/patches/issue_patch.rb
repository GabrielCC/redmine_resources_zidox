    ...
    module IssuePatch
      ...
      module InstanceMethods
        ...
        def parent_gets_resources?(parent_issue)
          logger.debug  "---parent_gets_resources? #{parent_issue.inspect}"
          logger.debug  "Manual estimation: #{parent_issue.manually_added_resource_estimation}"
          ...
          logger.debug  "Parent trackerid: #{parent_issue.tracker_id}"
